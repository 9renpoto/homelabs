...
- Split IaC by layer: PowerShell + Hyper-V module for VM construction, cloud-init for first boot, Ansible as the likely next step for richer in-guest config management, and Kustomize + ArgoCD for cluster delivery.
